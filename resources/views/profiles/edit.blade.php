...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update Profile Info') }}</div>
                ...
                <div class="card-body">
                    <form method="post" action="{{url('/profile/').'/'.$user->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right">{{ __('Edit Title') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-4 col-form-label text-md-right">{{ __('Edit description') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="url" class="col-md-4 col-form-label text-md-right">{{ __('Edit url') }}</label>
                         ...
                         <div class="form-group row pt-3">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control-file @error('image') is-invalid @enderror" name="image" required autofocus>
